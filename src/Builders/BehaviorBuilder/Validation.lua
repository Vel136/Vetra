...
local function ValidateBuilt(Config: BuiltBehavior): { string }
    ...
    Expect(Config.MaxDisplacement >= 0, "MaxDisplacement must be >= 0 (0 disables)")
    ...
    if Config.HighFidelitySegmentSize > 0 then
    ...
    Expect(Config.LODInterval >= 1, "LODInterval must be >= 1 (1 = step every frame)")
